...
import ModalElementorKitIcon from './ModalElementorKitIcon'
...
const MagicModalWrapper = ({ photoId, photoTitle, onCloseCallback = null, children }) => {
  ...
  // We get window.ElementorKit.modalAppHolder from our initial render in main.jsx:
  if (typeof window !== 'undefined' && window.ElementorKit && window.ElementorKit.modalAppHolder) {
    Modal.setAppElement(window.ElementorKit.modalAppHolder)
  }
  ...
  return (
    <Modal
      ...
      style={customStyles}
      contentLabel='ElementorKit'
      data-testid='modal-wrapper'
    >
      <div className={styles.modalInner}>
        <div className={styles.modalHeader}>
          <div className={styles.modalLogo}>
            <Link to='admin.php?page=elementorkit'>
              <ModalElementorKitIcon />
            </Link>
          </div>
