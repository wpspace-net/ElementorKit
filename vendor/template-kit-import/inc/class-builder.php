...
abstract class Builder extends Base {
	...
	public function get_manifest_data() {
		return get_post_meta( $this->kit_id, 'tk_manifest', true );
	}
	...
	public function get_template_kit_temporary_folder() {
		$template_kit_folder_name = get_post_meta( $this->kit_id, 'tk_folder_name', true );
	...
	public function get_source_zip_url() {
		return get_post_meta( $this->kit_id, 'tk_source_zip_url', true );
	}
}
