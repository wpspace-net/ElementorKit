...
abstract class CPT extends Base {
	 ...
	 * @var string
	 */
	public $menu_parent = TEMPLATE_KIT_IMPORT_SLUG;
	...
	public function get_cpt_args() {
		...
		return array(
			...
			'taxonomies'          => array(),
			'hierarchical'        => true,
			'public'              => defined( 'TEMPLATE_KIT_IMPORT_DEV' ) && TEMPLATE_KIT_IMPORT_DEV,
			'show_in_menu'        => defined( 'TEMPLATE_KIT_IMPORT_DEV' ) && TEMPLATE_KIT_IMPORT_DEV,
